...
grupo_no <- rendimiento_estudiantil[rendimiento_estudiantil$Amppliar_conocimiento == "No", "Horas_repaso_años", drop = FALSE]
grupo_si <- rendimiento_estudiantil[rendimiento_estudiantil$Amppliar_conocimiento == "Si", "Horas_repaso_años", drop = FALSE]
